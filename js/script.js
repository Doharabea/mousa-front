...
var searchBox=document.getElementById('top-search');
var visibilty=0;
btn.addEventListener('click',function(){
    $(".top-search").slideToggle();

});
function image_change(clicked_id){
    
    var x=document.getElementById(clicked_id);
    var v=x.getElementsByTagName('IMG');
    if(v[0].getAttribute("src")=="images/minus.png"){
        v[0].src="images/plus.png";
    console.log('minus');
    }
    else{
        v[0].src="images/minus.png";
